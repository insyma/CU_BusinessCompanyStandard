<script runat="server">
    ...
    Function spacer(Optional ByVal w As String = "1", Optional ByVal h As String = "1") As String
        Dim s as String = "<img width='" & w & "' height='" & h & "' src='" & getPath("layout") & "breaker.gif'  alt='*' />"
        Return s
    End Function
