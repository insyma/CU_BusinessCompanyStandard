...
<html xmlns="http://www.w3.org/1999/xhtml"
 ...
 xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <style type="text/css">
            ...
            @media only screen and (max-width:600px) {
                ...
                a[class=mobileButton]{display:block !important;font-size:15px !important; padding:6px 4px 8px 4px !important; margin:1px 0 !important; line-height: 18px !important; background:#82BB25 !important; text-align:center; color:#FFFFFF !important; text-decoration: none; text-shadow:#435928 1px 0 0 ; text-align:center;}
    ...
    <body style="padding:0; margin:0; -webkit-text-size-adjust:none; -ms-text-size-adjust:100%; background-color:<%=C_Body_BG%>; background-image: url('<%=getPath("layout") %><%=S_BG_Img %>');">
        <!--[if gte mso 9]>
