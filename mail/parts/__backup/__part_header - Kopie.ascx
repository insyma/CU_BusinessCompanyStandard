...
<!-- Header / Logo, Ausgabe -->
<table align="center"  border="0" cellpadding="0" cellspacing="0" style='<%=S_BoxShadow%>'>
    <tr>
        <td height="20" width="20" style="line-height: 0; font-size: 1px;"><%=spacer(20,20)%></td>
        <td height="20" style="line-height: 0; font-size: 1px;"><%=spacer(1,20)%></td>
        <td height="20" width="20" style="line-height: 0; font-size: 1px;"><%=spacer(20,20)%></td>
    ...
    <tr>
        ...
        <td style="width:600px; max-width:600px;">
            <!-- Logo -->
            <table align="left" width="298" style="border:1px solid #F9F9F9" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td bgcolor="#F9F9F9" style="<%=F_Text%>">
            ...
            <!-- Ausgabe -->
            <table align="left" width="298" class="mobileFullWidth" style="border:1px solid #F9F9F9" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td bgcolor="#F9F9F9" height="35" style="<%=F_Text%> text-align: right;" class="mobileFullWidthAlignLeft">
                        <span style="mso-table-lspace:0;mso-table-rspace:0;">
...
<table align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="20" style="line-height: 0; font-size: 1px;"><%=spacer(20,1)%></td>
        <td bgcolor="" width="600" style="height: 87px; width:600px; max-width:600px;">
            <span style='<%=F_Title%> font-size: 22px; line-height:30px; color: #fff; text-shadow: 2px 2px 2px rgba(0, 0, 0, 0.3);'>Erreichen Sie neue Zielgruppen</span><br/>
            <span style='<%=F_Title%> font-size: 14px; color: #fff; text-shadow: 2px 2px 2px rgba(0, 0, 0, 0.3);'>Mit einer Website oder Newsletter, die sich flexibel an die Gr&ouml;sse des Endger&auml;ts anpasst</span>
        </td>
        <td width="20" style="line-height: 0; font-size: 1px;"><%=spacer(20,1)%></td>
    </tr>
</table>
