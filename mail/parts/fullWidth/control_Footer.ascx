...
<script runat="server">
    ...
    Sub NavigationList_ItemDataBound(ByVal Sender As Object, ByVal e As RepeaterItemEventArgs)
        ...
        If (e.Item.ItemType = ListItemType.Item) Or (e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            End Select
            link.Target = "_blank"
            link.InnerHtml = entry.Fields("Labelling").Value & "aaa ~"
...
<% Else %>
    <table align="center" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td style="width:592px; max-width:592px; mso-table-lspace:0pt; mso-table-rspace:0pt; font-family:Tahoma, Geneva, sans-serif; font-size:13px; color:#FFFFFF;" align="left" bgcolor="#333333" height="74" valign="top">
