...
<%count = 0 %><%=vbcrlf%><%  Next%>
<%else %>
<table class="part_table" runat="server" id="EntryTable" width="600" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td align="left" width="19" style="background: #ffffff; line-height: 0; font-size: 1px;"><img src="http://www.cu3.ch/CU_BCS/mail/img/layout/breaker.gif" alt="*" width="15" height="5" /></td>
        <td align="left" width="562" valign="middle" style="background: #ffffff; color: #66676c; font-size: 12px; font-family: Arial, Verdana, sans-serif; line-height: 20px;">
        	<table width="562" style="background:#ffffff;" border="0" cellspacing="0" cellpadding="0">
            	<tr>
            		<td align="left" width="562" valign="middle" style="background: #ffffff; color: #66676c; font-size: 12px; font-family: Arial, Verdana, sans-serif; line-height: 20px;">                       
                        ...
                        <CU:CUObjectSet name="culist" runat="server" OnItemDataBound="culist_ItemDataBound">
                            <headertemplate>
                                <br />
                                <table width="562" border="0" cellspacing="0" cellpadding="5" align="left" style="clear:both;">
                                    <tr>
                                    	<th runat="server" id="tablehead" bgcolor="#66676c" align="left" valign="middle" style="padding: 5px 10px; color: #ffffff; font-size: 12px; font-weight: bold; font-family : Verdana,sans-serif; line-height: 14px;"><CU:CUField name="tableheader" runat="server" /></th>
            ...
            <table id="showBorder" runat="server" width="562" style="background:#ffffff;border-top: solid 1px #fb2701;" border="0">
            	<tr>
