...
<script runat="server">
    ...
    Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs)
        ' Laden der entsprechenden Inhalten aus den EInstellungen'
...
<table class="control_policy" width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff">
    <tr>        
        <td align="left" bgcolor="#ffffff" width="19" style="background: #ffffff; line-height: 0; font-size: 1px;"><img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" width="19" height="5" /></td>
		...
		<td bgcolor="#ffffff" align="left" width="19" style="background: #ffffff; line-height: 0; font-size: 1px;"><img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" width="19" height="5" /></td> 
	</tr>
</table>
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff">
    <tr>
        <td align="left" width="19" bgcolor="#ffffff" style="background: #ffffff; line-height: 0; font-size: 1px;"><img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" width="19" /></td>
        <td align="left" width="562" bgcolor="#ffffff" style="background:#ffffff;font-size: 10px; font-family: Arial, Verdana, sans-serif; color: #66676c; line-height: 16px;"> 
			<img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" height="20" /><br />
            ...
            <br /><img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" width="5" height="20" />
        </td>
        <td align="left" width="19" bgcolor="#ffffff" style="background: #ffffff; line-height: 0; font-size: 1px;"><img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" width="19" /></td>
    </tr>
</table>
