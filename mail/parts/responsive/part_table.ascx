    ...
    Protected Sub HeaderRepeater_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If E.Item.ItemType = ListItemType.Item Or E.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If Not field.Value = "" Then
                th.Attributes.Add("style", "border-right: solid 1px #ffffff;padding: 5px 10px; color: #66676c; font-size: 10px; font-weight: bold; font-family : Tahoma, Geneva, sans-serif; line-height: 14px;")
                if field.value = "-" then
					th.InnerHtml = " "   
				else
    ...
    Protected Sub RowRepeater_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs)
        If E.Item.ItemType = ListItemType.Item Or E.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Else
				...
				td.Attributes.Add("style", "border-right: solid 1px #ffffff;padding: 5px 10px; font-size: 10px; font-family :Tahoma, Geneva, sans-serif; color: #66676c; line-height: 14px; font-weight: bold; ")
...
<%count = 0 %><%=vbcrlf%><%  Next%>
<%else %>
<table class="part_table" runat="server" id="EntryTable" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td colspan="3" bgcolor="#FFFFFF">&nbsp;</td>   
      </tr>   
  <tr>
        <td align="left" width="15" bgcolor="#FFFFFF"></td>
        <td align="left" valign="middle" style="background: #ffffff; color: #66676c; font-size: 12px; font-family:Tahoma, Geneva, sans-serif; line-height: 20px; width:617px; max-width:617px;">
        	<table style="background:#ffffff;" border="0" cellspacing="0" cellpadding="0">
            	<tr>
            		<td align="left" valign="middle" style="background: #ffffff; line-height: 20px; width:617px; max-width:617px">                       

                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:17px; line-height:17px; color:#81BA25; background: #ffffff;"><CU:CUField Name="title" runat="server" /></span>
                        <br /><br />
                        ...
                        <CU:CUObjectSet name="culist" runat="server" OnItemDataBound="culist_ItemDataBound">
                            <headertemplate>
                                <br />
                                <table border="0" cellspacing="0" cellpadding="5" align="left" style="clear:both;">
                                    <tr>
                                    	<th runat="server" id="tablehead" bgcolor="#66676c" align="left" valign="middle" style="padding: 5px 10px; color: #ffffff; font-size: 13px; font-weight: bold; font-family : Tahoma, Geneva, sans-serif; line-height: 17px; width:617px; max-width:617px;"><CU:CUField name="tableheader" runat="server" /></th>
                        ...
                        <img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" alt="*" width="5" height="5" />
                    </td>
            	</tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" id="showBorder" style="background:#ffffff;border-top: solid 1px #fb2701;" runat="server">
            	<tr>
                    <td align="left" valign="top" height="2" style="background: #ffffff; line-height: 0; font-size: 11px; width:617px; max-width:617px;">
                    	<img src="http://www.contentupdate.net<%=p%>img/layout/breaker.gif" width="19" height="1" alt="*" />
                    hello</td>
				</tr>
			</table>
        </td>
<td align="left" width="15" style="background: #ffffff; line-height: 0; font-size: 1px;">&nbsp;</td>
    </tr>
</table>
<%end if %>