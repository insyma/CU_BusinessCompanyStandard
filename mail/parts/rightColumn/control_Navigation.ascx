...
<CU:CUObjectSet ID="NavigationList" runat="server" OnItemDataBound="NavigationList_ItemDataBound">
    <HeaderTemplate>
<table class="control_navigation" width="600" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" style="background: #ffffff;">
    <tr>
        ...
        <table width="562" style="background:#ffffff;border-top: solid 1px #fb2701;" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="left" width="562" valign="top" height="2" style="background: #ffffff; line-height: 0; font-size: 1px;">
                    <img src="http://www.cu3.ch/cu_BCS/mail/img/layout/breaker.gif" width="19" height="8" alt="*" />
                </td>
            </tr>
        </table>
        ...
        <FooterTemplate>
            ...
            <tr>
                <td colspan="<%=count%>" width="562"  bgcolor="#ffffff" style="background: #ffffff;line-height: 0; font-size: 1px; "><img src="http://www.cu3.ch/cu_BCS/mail/img/layout/breaker.gif" width="5" height="8" alt="*" /></td>
            </tr>
        </table>
        </td>
