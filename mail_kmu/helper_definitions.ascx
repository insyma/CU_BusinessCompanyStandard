<script runat="server">
    ...
    Dim PrimaryColor as String = "#009afe"
    ...
    Dim border as String = "border: 1px solid #eeeeee;"
    
    'BUTTONS
    Dim StandardButtonBGColor as String = "#009afe"
    Dim StandardButtonBGColorHover as String = "#009afe"
    ...
    Dim S_Header_Border as String = ""
    
    'FOOTER
    Dim F_Footer_Title as String = FontFamily & FontSizeTitle & FontAdds & " font-weight:bold; "
    Dim C_Footer_Title as String = "color: "& TitleColor &";"
    Dim F_Footer_Text as String = FontFamily & FontSizeText & FontAdds
    Dim C_Footer_Text as String = "color: "& TitleColor &";"
    Dim F_Footer_Link as String = FontFamily & FontSizeText & FontAdds
    Dim C_Footer_Link as String = "color: "& PrimaryColor &";"
    
    Dim C_Footer_Background as String = "#E0E0E0"
    ...
    Dim C_SubFooter_Background as String = "#E9E9E9"
    Dim S_SubFooter_Border as String = border
    
    'NAVIGATION
    Dim F_Nav_Link as String = FontFamily & FontSizeText & FontAdds
    Dim C_Nav_Link as String = "color: "& TitleColor &"; font-weight: bold;"
    Dim C_Nav_Background as String = "#e0e0e0"
    Dim C_Nav_Style as String = "border-bottom: none;"
    ...
    Dim C_Index_Title as String = "color: #757575;"
    Dim F_Index_Link as String = FontFamily & FontSizeText & FontAdds
    Dim C_Index_Link as String = "color: #757575;"
    Dim C_Index_Background as String = "#eeeeee"
    ...
    Dim BG_Standard_Button as String = "#009afe"
    ...
    Dim BG_Promo_Button as String = "#009afe"
    ...
    Dim BG_Boxen_Button as String = "#009afe"
    ...
    'Dim C_Footer_Title as String = "color: #666666;"
    'Dim C_Footer_Text as String = "color: #666666;"
    'Dim C_Footer_Link as String = "color: #666666;"
    'Dim C_Footer_Button as String = "color: #666666;"
    
    
    Dim C_Footer_BG as String = "#E0E0E0"
    Dim C_Footer_Navig_BG as String = "#444444"
    Dim C_Footer_INSYMA_BG as String = "#314C0F"
    
    Dim C_Body_BG as String = "#E0E0E0"
