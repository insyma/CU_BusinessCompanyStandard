...
<script runat="server">
    ...
    Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs)
        ...
        if Container.Fields("farbschema").properties("value").value = "2" then
            C_Promo_Title = "color: #ffffff;"
            C_Promo_Text = "color: #ffffff"
            C_Promo_Link = "color: #ffffff"
            C_Promo_Background = "#333333"
            S_Promo_Border = "border: 1px solid #000000;"
            S_Promo_Link_Border = "border-bottom: 1px solid #e0e0e0;"
            
            F_Promo_Button = FontFamily & FontSizeText & FontAdds
            C_Promo_Button = "color: #E30421;"
            BG_Promo_Button = "#ffffff"
            
            'Definition for diffrent hoverstate on diffrent backgrounds
            Dim C_Promo_Button_HOVER = "color: #E30421;"
            Dim BG_Promo_Button_HOVER = PrimaryColor
