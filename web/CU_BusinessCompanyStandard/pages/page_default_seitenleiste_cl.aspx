...
<%@ Register TagPrefix="Control" TagName="AddThis" Src="../parts/control_AddThis.ascx" %>
...
<script runat="server"> 
    ...
    Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs)
        ...
        End If
        If CUPage.Containers("seitenleiste").Containers.count > 0 Then
            aside.Visible = True
        Else
            aside.Visible = False
        End If
...
<body class="page pid-<%=currpage%>" data-curr-page="<%=currpage%>">
        ...
        <div id="wrapper" class="con-wrapper clearfix">
            ...
            <div class="holder con-inhalt">
                ...
                <aside id="aside" runat="server">
                    <cu:cuplaceholder id="seitenleiste" runat="server" class="seitenleiste"></cu:cuplaceholder>
                </aside>
            </div>
        </div>
