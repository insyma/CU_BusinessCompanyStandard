...
<script runat="server">
    ...
    Sub Page_Load(ByVal Src As Object, ByVal E As EventArgs)
        ...
        prodname = Container.Fields("zen_shop_produkte_entry_name").Value
    ...
    Protected Sub ProductImageBindItem(ByVal sender As System.Object, ByVal e As RepeaterItemEventArgs)
        ...
        End If
    End Sub
    Protected Sub ProductInformationBindItem(ByVal sender As System.Object, ByVal e As RepeaterItemEventArgs)
        If (e.Item.ItemType = ListItemType.Item) Or (e.Item.ItemType = ListItemType.AlternatingItem) Then
            ...
            If e.Item.ItemIndex > 0 Then
                'cssclass.Text = "style='display: none;' id='item_" & e.Item.ItemIndex & "'"
            End If
...
<!-- Product Image -->    
<div class="part part-bild-text insymaNewThumbs detail openInOverlay">
...
<div class="textcon">
    <CU:CUField name="zen_shop_produkte_entry_desc" tag="p" runat="server" />
            ...
            <ul class="shop-produkt-detail">
                ...
                <li class="action">
                    <asp:PlaceHolder runat="server" id="wkButton">
                        <button class="wkButton" onclick="insymaShop.addToBasket(<%=parent_id%>,<asp:literal runat="server" ID="prod_id" />)"><%=b.fields("lbl_shop_warenkorb").value%></button>
                    </asp:PlaceHolder>
    ...
    <!-- Accordion -->
    <CU:CUObjectSet name="zen_shop_produkte_entry_list_info" runat="server"  OnItemDataBound="ProductInformationBindItem">
        <HeaderTemplate><h2><%=b.fields("lbl_shop_prodinfo").value%></h2></HeaderTemplate>
        <ItemTemplate>
            <CU:CUField name="zen_shop_produkte_entry_list_info_entry_title" runat="server" tag="h3" tagclass="titledesc" />
            <div class="subcontent part-basic" <asp:literal id="cssclass" runat="server" />>
                <CU:CUField name="zen_shop_produkte_entry_list_info_entry_text" runat="server" />
            </div>
        </ItemTemplate> 
    </CU:CUObjectSet>

    <p>&nbsp;</p>
    <a class="link blocked" href="javascript:history.back();"><CU:CUField Name="zurueck" runat="server" /></a>
</div>     

<script type="text/javascript">
/* <![CDATA[ */
    //insymaScripts._setProdInfo();
    //insymaScripts._setProdImg("1");
/* ]]> */  
</script>
